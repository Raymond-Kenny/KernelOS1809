...
set this=-------------------------------------------------------------------------------- ^& echo                                Welcome to KernelOS       				       ^& echo -------------------------------------------------------------------------------- ^& echo OS: Windows 10 1809 ^& echo Creation Date: 03/13/2024
cls
echo %this%
...
timeout /t 3 /nobreak >NUL 2>&1
del /F /Q "%SYSTEMDRIVE%\ProgramData\Microsoft\Windows\Start Menu\Programs\Startup\KernelOS1809.bat" >NUL 2>&1
